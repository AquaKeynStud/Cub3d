...
static void	move_forward(t_data *data)
{
	...
	new_x = data->player.x + data->player.ori_x * PLAYER_SPEED;
	new_y = data->player.y + data->player.ori_y * PLAYER_SPEED;
...
static void	move_right(t_data *data)
{
	...
	new_x = data->player.x + data->player.ori_y * PLAYER_SPEED;
	new_y = data->player.y + (-data->player.ori_x) * PLAYER_SPEED;
	if (data->map.map[(int)new_y][(int)new_x] != '1')
	{
		data->player.x = new_x;
		data->player.y = new_y;
